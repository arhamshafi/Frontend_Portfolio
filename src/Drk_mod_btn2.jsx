...
const Drk_mod_btn2 = () => {
    ...
    let { setdrk_mod, drk_mod } = useContext(App_context)

    return (
        <StyledWrapper>
            <label className="theme-switch">
                <input type="checkbox" className="theme-switch__checkbox" checked={drk_mod} onChange={() => setdrk_mod(!drk_mod)} />
